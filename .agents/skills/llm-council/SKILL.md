...
- **Output is always markdown in chat.** Never generate HTML files or reports — the verdict is presented directly in the conversation and should be scannable with headers and bullet points.
